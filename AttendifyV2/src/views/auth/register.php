...
<head>
    <meta charset="UTF-8">
    <title>AttendifyV2 - Sign up</title>
...
<div class="auth-wrapper">
    <div class="auth-card glass">
        ...
        <p class="auth-subtitle">Sign up as a student to start recording your attendance.</p>
        ...
        <form method="post" action="<?= BASE_URL ?>/register">
            ...
            <div class="form-group">
                ...
                <input type="text" id="student_number" name="student_number" required value="<?= isset($studentNumber) ? htmlspecialchars($studentNumber, ENT_QUOTES, 'UTF-8') : '' ?>">
            </div>
            <div class="form-group">
